defmodule KrakenApi do
  ...
  def get_deposit_methods(params \\ %{}) do
    invoke_private_api("DepositMethods", params)
  end

  def get_deposit_addresses(params \\ %{}) do
    invoke_private_api("DepositAddresses", params)
  end

  def get_status_of_recent_deposits(params \\ %{}) do
    invoke_private_api("DepositStatus", params)
  end

  def get_withdrawal_information(params \\ %{}) do
    invoke_private_api("WithdrawInfo", params)
  end

  def withdraw_funds(params \\ %{}) do
    invoke_private_api("Withdraw", params)
  end

  def get_status_of_recent_withdrawals(params \\ %{}) do
    invoke_private_api("WithdrawStatus", params)
  end

  def request_withdrawal_cancelation(params \\ %{}) do
    invoke_private_api("WithdrawCancel", params)
  end
